...
func (c *Compiler) extractAdditionalConfigurations(
	...
	workflowData.LabelCommand, workflowData.LabelCommandEvents, workflowData.LabelCommandDecentralized, workflowData.LabelCommandRemoveLabel, workflowData.LabelCommandStatusCommand = c.extractLabelCommandConfig(frontmatter)

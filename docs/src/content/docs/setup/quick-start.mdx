...
>
> Never edit `.lock.yml` by hand; treat it as generated output. In your `.md` file, **frontmatter** means the configuration block between the `---` markers at the top, and it controls schedule, engine, and tool access.
>
